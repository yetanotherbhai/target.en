...
|Date|Topic|Changes|
| --- | --- | --- |
|March 6, 2019|[Upgrading from at.js 1.x to at.js 2.0.0](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md)|Added at_property row to the  "at.js 1.x parameters to at.js 2.0.0 payload mapping" table.<br>Added new section: "Use TriggerView to ensure that A4T works correctly with at.js 2.0.0 and SPAs."|
