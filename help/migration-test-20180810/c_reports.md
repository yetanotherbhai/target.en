...
Metric numbers, for example visits, reported by [!DNL  Target] will always be lower than the reported numbers in other [!DNL  Marketing Cloud] solutions for a number of reasons: 
