...
title: A/B Test
topic: Standard
uuid: 0e486dad-05e5-4a97-a21a-d0f3652e3582
index: y
internal: n
snippet: y
translate: y
...
</draft-comment>This video demonstrates how to create an A/B test using the [!DNL  Target] three-step guided workflow. 
...
>1. Specify your [ activity URL ](t_test_ab.md#concept_D28549AAA0A14E3BB5F05F32BE8ABC90), then click ** [!UICONTROL  Create] **.
...
>   For more information about adding and modifying experiences in the [!UICONTROL  Visual Experience Composer], see [ Add Experience ](t_test_ab.md#task_454646F2895242D3B92DC395A0CE1A00). To modify Experience B, start with Step 3. 
>
...
>1. In the [!UICONTROL  Audience] box, click the edit icon (  ![](graphics/icon_edit.png) ), then [ select the audience ](t_test_ab.md#concept_A268236C1224451DB7844BF67F41A087) for your activity.
...
</draft-comment>When prompted during activity creation, specify the activity URL. Type the complete URL (including ` http://`), then click ** [!UICONTROL  Create] **. 
...
In the [!UICONTROL  Audience] box, click the Edit icon (  ![](../graphics/icon_more_options.png) ), then click ** [!UICONTROL  Replace Audience] **. 
