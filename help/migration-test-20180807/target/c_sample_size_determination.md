...
uuid: 3f510410-9b20-4472-b070-c3a5dda856de
index: y
internal: n
snippet: y
translate: y
...
* [Overview](c_sample_size_determination.md#section_6B8725BD704C4AFE939EF2A6B6E834E6)
* [Statistical Significance](c_sample_size_determination.md#section_8230FB9C6D1241D8B1786B72B379C3CD)
* [Statistical Power](c_sample_size_determination.md#section_1169C27F8E4643719D38FB9D6EBEB535)
* [Minimum Reliably Detectable Lift](c_sample_size_determination.md#section_6101367EE9634C298410BBC2148E33A9)
* [Baseline Conversion Rate](c_sample_size_determination.md#section_39380C9CA3C649B6BE6E1F8A06178B05)
* [Estimating the Sample Size](c_sample_size_determination.md#section_19009F165505429E95291E6976E498DD)
* [Revenue per Visit Metric](c_sample_size_determination.md#section_C704C0861C9B4641AB02E911648D2DC2)
* [Correction for Comparing Multiple Offers](c_sample_size_determination.md#section_1474113764224D0B85472D8B023CCA15)
* [Conclusion](c_sample_size_determination.md#section_AEA2427B90AE4E9395C7FF4F9C5CA066)


## Overview {#section_6B8725BD704C4AFE939EF2A6B6E834E6}

Before setting up your A/B test, use the [sample size calculator](https://docs.adobe.com/content/target-microsite/testcalculator.html). 
...
This article discusses the factors that must be balanced when a sample size is determined and introduces a spreadsheet calculator for estimating an adequate sample size. Calculating the sample size using the [sample size calculator](https://docs.adobe.com/content/target-microsite/testcalculator.html) before any A/B test begins ensures that you always run high quality A/B tests that comply with statistical standards. 
...
[Top](c_sample_size_determination.md#concept_2801F552DB874C20B8A17C1B774C0383) 
...
The [sample size calculator](http://adobe-target.com/testcalculator.html) can help you configure the RPV metric. When you open the calculator, you'll see a tab labeled RPV Metric. You'll need the following information when using the RPV version of the calculator: 
