  ...
  <tr> 
   ...
   <td colname="col3"> <p>Moved the following issues from the Known Issues section to the Resolved Issues section:</p> <p> 
     <ul id="ul_3F3FB6CA7D4C47FD8D3CD4D62010CA41"> 
      ...
      <li id="li_383985E96B6546E099993174A3AE28AA"> <p>Since the release of <span class="keyword">Target</span> 17.4.1 (April 27, 2017), using the Insert Image action in the Visual Experience Composer (VEC) causes the offer content to not be delivered when using the at.js library. </p> </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Revised topic, specifically:</p> <p> 
     <ul id="ul_EC3D8A238F374A95913B8E53AE6645A3"> 
      ...
      <li id="li_93356441F9EF49219E99E866DBBD44FE">Changed the code examples.</li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Made the following changes:</p> <p> 
     <ul id="ul_358565F728C64E32A406CACE7A20BA09"> 
      <li id="li_ED95C6621DCC480CA01CD55962805B4A"> <p>Revised the first paragraph under "Why do I have to include the additional code in my at.js library header section?"</p> </li> 
      <li id="li_CD5E931B80504F5BA33A7DF8651D2081"> <p>Updated the sample code.</p> </li> 
      <li id="li_527900825B74451A94F904BA82EF8C60"> <p>Added new FAQ: "Can I use custom/HTML redirect offers?"</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#reference_F5D9EF735F1044C38E208F3A178903B2" format="dita" scope="local">Useful Variables, Profiles, Parameters, and Methods</a> </p> </td> 
   <td colname="col3"> <p>Added the following profiles to the "Geo and Mobile Carrier Profiles" list:</p> <p> 
     <ul id="ul_F645ACEE21394E9694996B768B06AA6A"> 
      <li id="li_CA881C57D5AB44D9BFADC011C0187A96"><span class="codeph">profile.geolocation.latitude</span> </li> 
      <li id="li_51BD7E49B07844A38B7550ED315A2D01"><span class="codeph">profile.geolocation.longitude</span> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_5B4D99DE685348FB877929EE0F942670" format="dita" scope="local">Geo</a> </p> </td> 
   <td colname="col3"> <p>Added the following <span class="codeph">profile.geolocation</span> values to the "Using Geo-Targeting Values as Tokens" list: </p> <p> 
     <ul id="ul_B5C9ACE8C2B240C5B2E95AD0D620B915"> 
      <li id="li_9B1C9931008F4907B261AD7F4291AD0F"><span class="codeph">${profile.geolocation.latitude}</span> </li> 
      <li id="li_80912202DCAA4E3BB1133EE724396BC5"><span class="codeph">${profile.geolocation.longitude}</span> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov/c_target-transition-classic-to-standard.xml#concept_D8DB7801889A464D9197A739F7B185A7" format="dita" scope="local">Advanced Feature Considerations</a> </p> </td> 
   <td colname="col3"> <p>Added information about using geo profiles and <span class="codeph">profile.geolocation</span> values to target by latitude and longitude. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Moved the following items from the Known Issues table to the Resolved Issues table:</p> <p> 
     <ul id="ul_91974D626E0B41258F4041CFC896CD9B"> 
      <li id="li_0786BBB814CB492B87F7346343EC0713"> <p>Reports: You can now view multiple metrics in a report.</p> </li> 
      <li id="li_D611AD8B49284128B82E3E3AF929D059"> <p>Offers: Images deleted from the <span class="wintitle">Image Offers</span> library ( <span class="wintitle">Offers</span> &gt; <span class="wintitle">Image Offers</span> ) remain visible in the UI. </p> </li> 
      <li id="li_2EEB2FB3031540C984207814CB32D9A5"> <p>When users attempt to download <span class="codeph">at.js</span> from the <a href="../ov2/c_target-atjs-implementation.xml#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Implementation details</a> page after updating <span class="codeph">at.js</span> settings, <span class="codeph">mbox.js</span> is downloaded instead of <span class="codeph">at.js</span>. (TGT-23069) </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Release 17.4.1 <a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Release Notes</a> </p> </td> 
...
## Adobe Target Standard/Premium 17.3.1 (March 30, 2017) {#section_E586474A24F442E4A54CBFA0987F123A}



<table id="table_27B1BDCA778F4A82B5D77EA6F34DF267"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry">Date</th> 
   <th colname="col2" class="entry">Topic</th> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1">April 26, 2017</td> 
   <td colname="col2"> <p><a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Target Release Notes</a> </p> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> <p><a href="../ov2/c_target-atjs-implementation.xml#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">at.js Version Details</a> </p> </td> 
   <td colname="col3"> <p>Added information and possible workarounds about the algorithm for extracting the top-level domain that should be used when saving cookies. It has changed in <span class="codeph">at.js</span> version 0.9.6. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">April 25, 2017</td> 
   <td colname="col2"> <p><a href="../recs/c_products.xml#concept_1228B31E3D0B483B9DD42C5E2AE436E3" format="dita" scope="local">Feeds</a> </p> </td> 
   <td colname="col3"> <p>Added additional information about feed-status indicators.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">April 24, 2017</td> 
   <td colname="col2"> <p><a href="t_automated_personalization.xml#task_71AA6922AFD447EA8C5E610A78ABA714" format="dita" scope="local">Estimate the Traffic Required for Success</a> </p> </td> 
   <td colname="col3">Updated the sample size needed for a successful Automated Personalization activity.</td> 
  </tr> 
  <tr> 
   <td colname="col1">April 21, 2017</td> 
   <td colname="col2"> <p><a href="../ov/c_understanding-global-mbox.xml#concept_246B0FCF5A7542879DA6613C0C59267F" format="dita" scope="local">Global mbox Frequently Asked Questions</a> </p> </td> 
   <td colname="col3"> <p>New topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">April 19, 2017</td> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#reference_BBE83F513B5B4E03BBC3F50D90864245" format="dita" scope="local">adobe.target.applyOffer(options)</a> </p> </td> 
   <td colname="col3"> <p>Removed "element" key from the table.</p> <p>Edited the description for the "selector" key.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"><a href="c_target_rules.xml#concept_D9F21B416F1F49159F03036BA2DD54FD" format="dita" scope="local">Visitor Profile Lifetime</a> </td> 
   <td colname="col3"> <p>Edited entire topic to reflect that the lifetime profile can be extended by as many as 90 days.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">April 14, 2017</td> 
   <td colname="col2"> <p><a href="r_success_metrics.xml#reference_D011575C85DA48E989A244593D9B9924" format="dita" scope="local">Success Metrics</a> </p> </td> 
   <td colname="col3"> <p>Made significant text edits.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_activities.xml#concept_1780C11FEA57440499F0047DD6900E0F" format="dita" scope="local">Priority</a> </p> </td> 
   <td colname="col3"> <p>Changed sentence in two places that explained tiebreakers when all or no activities have targeting. The activity that was approved first is displayed, rather than the activity that was first enabled.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="9">April 13, 2017</td> 
   <td colname="col2"><a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Target Release Notes</a> </td> 
   <td colname="col3"> <p>Added the "Target Platform" section that includes information about <span class="filepath">at.js</span> version 0.9.6. </p> <p>Added top row in the "Target Standard/Premium 17.3.1" section that contains new information about <span class="keyword">Analytics for Target</span> (A4T) and Redirect Offers </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../a4t/c_a4t-faq-redirect-offers.xml#concept_21BF213F10E1414A9DCD4A98AF207905" format="dita" scope="local">Redirect Offers - A4T FAQ</a> </p> </td> 
   <td colname="col3"> <p>New topic.</p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p><a href="c_manage_content.xml#task_33C80CD722564303B687948261484F94" format="dita" scope="local">Create Redirect Offers</a> </p> <p><a href="t_redirect_offer.xml#task_9578678D42784F5EB9638F8AC8C911FA" format="dita" scope="local">Redirect to a URL</a> </p> </td> 
   <td colname="col3"> <p>Added link to topic that describes the minimum requirements needed to use redirect offers with A4T.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#concept_8DACBC47ABDE4279BB102B42609FE506" format="dita" scope="local">targetGlobalSettings()</a> </p> </td> 
   <td colname="col3">Added row for the <span class="codeph">selectorsPollingTimeout</span> setting. </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">at.js Version Details</a> </p> </td> 
   <td colname="col3"> <p>Added section for <span class="filepath">at.js</span> version 0.9.6. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#reference_C81525D1598A4A1199740DCAB81A7FDF" format="dita" scope="local">adobe.target.getOffer(options)</a> </p> </td> 
   <td colname="col3"> <p>Edited entire topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#reference_BBE83F513B5B4E03BBC3F50D90864245" format="dita" scope="local">adobe.target.applyOffer(options)</a> </p> </td> 
   <td colname="col3"> <p>Changed the key and description for the "offer" key.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_activities.xml#concept_D317A95A1AB54674BA7AB65C7985BA03" format="dita" scope="local">Activities</a> </p> </td> 
   <td colname="col3"> <p>Added information to both topics about deleting activities in <span class="keyword">Target Classic</span> and their impact in <span class="keyword">Target Standard/Premium</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_activities.xml#concept_D317A95A1AB54674BA7AB65C7985BA03" format="dita" scope="local">Activities</a> </p> </td> 
   <td colname="col3"> <p>Added new row to "Limitations" table: Audiences and Locations.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_0D0002A1EBDF420E9C50E2A46F36629B" format="dita" scope="local">Confidence Level and Confidence Interval</a> </p> </td> 
   <td colname="col3"> <p>Added note about using the Complete Confidence Calculator with A4T.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">April 8, 2017</td> 
   <td colname="col2"> <p><a href="https://www.adobe.io/apis/marketingcloud/target/docs/getting-started.html" format="html" scope="external">Target API Documentation</a> </p> </td> 
   <td colname="col3"> <p>Added link in the left navigational menu to the Target API Documentation website.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">April 7, 2017</td> 
   <td colname="col2"> <p><a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Target Release Notes</a> </p> <p><a href="c_reports.xml#concept_3F276FF2BBB2499388F97451D6DE2E75" format="dita" scope="local">Downloading Data in a CSV File</a> </p> </td> 
   <td colname="col3"> <p>Added information to both topics about the Experience column in the <span class="wintitle">Order Details</span> report. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="https://docs.adobe.com/content/adobetarget/transition-hub.html" format="html" scope="external">Adobe Target Transition Hub</a> </p> </td> 
   <td colname="col3"> <p>Added link to the Adobe Target Transition Hub that tells you everything you need to know about making the move from Adobe <span class="keyword">Target Classic</span> (<span class="keyword">Test&amp;Target</span>) to the new <span class="keyword">Adobe Target</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">April 6, 2017</td> 
   <td colname="col2"> <p><a href="c_activities.xml#concept_D317A95A1AB54674BA7AB65C7985BA03" format="dita" scope="local">Activities</a> </p> <p><a href="c_activities.xml#concept_0572EF9B378F495B8905925C692BA7F6" format="dita" scope="local">Troubleshooting Activities</a> </p> </td> 
   <td colname="col3"> <p>Added information about performing certain actions, such as activating an activity outside of the UI using API methods, that the update can take up to ten minutes to propagate to the UI.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="4">April 5, 2017</td> 
   <td colname="col2"> <p><a href="vec-best-pracitces-and-troubleshooting.xml#concept_E284B3F704C04406B174D9050A2528A6" format="dita" scope="local">Visual Experience Composer Best Practices and Limitations</a> </p> </td> 
   <td colname="col3"> <p>Added information about downloading a new <span class="filepath">mbox.js</span> file if you are moving from <span class="keyword">Target Classic</span> to <span class="keyword">Target Standard/Premium</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Download at.js</a> </p> </td> 
   <td colname="col3"> <p>Added <span class="codeph">&lt;<span class="varname">version number</span>&gt;</span> to Step 3 under "Download <span class="filepath">at.js</span> Using the Target Download API." </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov/c_target-transition-classic-to-standard.xml#concept_0505A57DBDD04AA48BC988553E049239" format="dita" scope="local">Technical Implementation</a> </p> </td> 
   <td colname="col3"> <p>Added Important Note in Step 1.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Target Release Notes</a> </p> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added that the ability to view multiple metrics in a report, included in the Target 17.3.1 release (March 30, 2017) has been removed due to unexpected behavior. This feature will be available again in an upcoming release.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="t_test_ab.xml#concept_D28549AAA0A14E3BB5F05F32BE8ABC90" format="dita" scope="local">Activity URL</a> </p> <p><a href="t_automated_personalization.xml#task_8AAF837796D74CF893CA2F88BA1491C9" format="dita" scope="local">Creating an Automated Personalization Activity</a> </p> <p><a href="t_experience_target.xml#concept_D28549AAA0A14E3BB5F05F32BE8ABC90" format="dita" scope="local">Activity URL</a> </p> <p><a href="../mvt/c_multivariate_testing.xml#concept_C12E4A85FF3B4E518E3110F6CF1AF9C0" format="dita" scope="local">Activity URL</a> </p> <p><a href="../recs/t_create_recs_activity.xml#task_6874328773C64C44A73F0A130AD3F96F" format="dita" scope="local">Create a Recommendations Activity</a> </p> </td> 
   <td colname="col3"> <p>Added following note to all topics listed:</p> <p> <p>Note: <span class="keyword">Target</span> does not differentiate between URL protocols (<span class="filepath">https</span> and <span class="filepath">http</span>). As a result, <span class="filepath">https://adobe.com</span> and <span class="filepath">http://adobe.com</span> both match. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">March 31, 2017</td> 
   <td colname="col2"> <p><a href="../ov2/c_hosts.xml#concept_90573F5A52E04600A8C3C5897880C10F" format="dita" scope="local">Manage Hosts and Environments</a> </p> </td> 
   <td colname="col3"> <p>Removed sentence that stated <span class="wintitle">Automated Personalization</span> activities do not support hosts and environments. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added Known Issue about the Extreme Orders filtering option when viewing multiple metrics in a report.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="7">March 30, 2017</td> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_0FE1E8DACD104F8B870B0BADE3197F0A" format="dita" scope="local">Time Frame</a> </p> </td> 
   <td colname="col3"> <p>Added information about the <span class="wintitle">Week and Day Parting</span> option. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Added information about adding exclusion rules and excluding audiences when combining multiple audiences.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_manage_content.xml#concept_D2548B486C984B1E97ED7A72075B8EEA" format="dita" scope="local">Troubleshooting Content Delivery</a> </p> </td> 
   <td colname="col3"> <p>Added the following troubleshooting section:</p> <p> 
     <ul id="ul_F44146680797458BBB9B9BD1BBAF6409"> 
      <li id="li_FA49D8273F97437CAD99F62B5E1D56A0"> <p>Target Cookie Does Not Get Set</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../recs/c_products.xml#concept_1228B31E3D0B483B9DD42C5E2AE436E3" format="dita" scope="local">Feeds</a> </p> </td> 
   <td colname="col3"> <p>Added the following section:</p> <p> 
     <ul id="ul_8BC6097512474F378C0F21F9097E4610"> 
      <li id="li_6C7B9F78B075440788310B65C91D5BB2"> <p>Feed Status Indicators</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_D9F21B416F1F49159F03036BA2DD54FD" format="dita" scope="local">Visitor Profile Lifetime</a> </p> </td> 
   <td colname="col3"> <p>Changed paragraph indicating that you have to download a new <span class="filepath">at.js</span> file after extending the profile lifetime. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Added note that newly created audiences appear in the list after a few seconds of processing delay. If the audience does not display immediately in the list, search for the audience or refresh the list.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added Known Issue about deleted image offers remaining visible in the UI.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Release 17.3.1 <a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Release Notes</a> </p> </td> 
   <td colname="col3"> <p>This release includes enhancements and fixes. You can read about them and link to the documentation from the Release Notes. This release also includes many documentation updates throughout the help.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
## Adobe Target Standard/Premium 17.2.1 (February 21, 2017) {#section_5E55FA0C7B5C4A2C9368B31E983B6510}



<table id="table_5129B40030B2435E8F4839E6B06A4ECF"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry">Date</th> 
   <th colname="col2" class="entry">Topic</th> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1" morerows="1">March 27, 2017</td> 
   <td colname="col2"> <p><a href="../recs/c_algorithms.xml#task_2B0ED54AFBF64C56916B6E1F4DC0DC3B" format="dita" scope="local">Base the Recommendation on a Recommendation Key</a> </p> </td> 
   <td colname="col3"> <p>Edited the "Description" column for Favorite Category. Specifically, changed the recency/frequency criteria and description.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../a4t/c_a4t-faq-viewing-reports.xml#concept_72A95F6466A04B409FCD5989A6B6A554" format="dita" scope="local">Viewing Reports - A4T FAQ</a> </p> </td> 
   <td colname="col3"> <p>Added detailed example under:</p> <p> 
     <ul id="ul_6791C5611DE542AFB1CC361B350F76E3"> 
      <li id="li_6A682D34E4D44BEFBD71B73ED84E5131"> <p>Why are Target metrics sent to Analytics even after the activity has been deactivated?</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">March 20, 2017</td> 
   <td colname="col2"> <p><a href="../a4t/a4t.xml#reference_8625DA119F1049B4A87CE967E790726B" format="dita" scope="local">A4T Frequently Asked Questions</a> </p> </td> 
   <td colname="col3"> <p>Reorganized entire section and added sub topics for better accessability.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../a4t/c_a4t-faq-viewing-reports.xml#concept_72A95F6466A04B409FCD5989A6B6A554" format="dita" scope="local">Viewing Reports (A4T FAQ)</a> </p> </td> 
   <td colname="col3"> <p>Updated the following FAQ with additional information:</p> <p> 
     <ul id="ul_3A755B2D0FF24D609DE18F9EF75F0446"> 
      <li id="li_35227E87089C435DBFF94520379CC4B1"> <p>Why are Target metrics sent to Analytics even after the activity has been deactivated?</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">March 15, 2017</td> 
   <td colname="col2"> <p><a href="../a4t/c_a4t-faq-viewing-reports.xml#concept_72A95F6466A04B409FCD5989A6B6A554" format="dita" scope="local">Viewing Reports (A4T FAQ)</a> </p> </td> 
   <td colname="col3"> <p>Added the following FAQ:</p> <p> 
     <ul id="ul_9333FED6F616421AAE1BA18A006CCF52"> 
      <li id="li_3DC13EC37FCF452CA7AF01336D0BF8F1"> <p>Why do Analytics and Analytics for Target (A4T) calculate numbers for the Unique Visitors metric differently?</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">March 14, 2017</td> 
   <td colname="col2"> <p><a href="c_activities.xml#concept_1780C11FEA57440499F0047DD6900E0F" format="dita" scope="local">Priority</a> </p> </td> 
   <td colname="col3">Under "Target Classic or Target Standard/Premium Form-Based Composer With Non-Global mboxes ," number 4 now reads: <p>If all or none have targeting, then the least recently activated activity is displayed.</p> <p>Previously instead of "least recently activated activity," it read "most recently activated activity."</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">March 13, 2017</td> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#task_DE55DCE9AC2F49728395665DE1B1E6EA" format="dita" scope="local">Migrate to at.js from mbox.js</a> </p> </td> 
   <td colname="col3"> <p>Added information about running both <span class="keyword">at.js</span> and <span class="keyword">mbox.js</span> on different web pages on your site. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="3">March 10, 2017</td> 
   <td colname="col2"> <p><a href="../recs/c_products.xml#concept_1228B31E3D0B483B9DD42C5E2AE436E3" format="dita" scope="local">Feeds</a> </p> </td> 
   <td colname="col3"> <p>Added following information:</p> <p> 
     <ul id="ul_24788C3A5C794EEBA651369F84212E63"> 
      <li id="li_FDE9E0CE66334E6AB1B80B5BA08C752A"> <p> <p type="important">Note: Do not enclose values in double quotes ( " ) in your <span class="filepath">.csv</span> file unless they are intentional. If you enclose values in double quotes you must escape them by enclosing them in another set of double quotes. Double quotes that are not escaped will prevent the recommendations feed from loading properly. </p> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../a4t/a4t.xml#concept_CE78750AC2A4487D8ACD9369B3EAC85A" format="dita" scope="local">Analytics for Target Implementation</a> </p> </td> 
   <td colname="col3"> <p>Added Step 8: Validate the Implementation.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#reference_CF0B0D71987D487EA0BCDE128C80ABEB" format="dita" scope="local">Single-Page Application Implementation</a> </p> </td> 
   <td colname="col3"> <p>Added the following note:</p> <p> <p>Note: If you are using the Analytics for Target (A4T) implementation, ensure that you complete Step 8 in <a href="../a4t/a4t.xml#concept_CE78750AC2A4487D8ACD9369B3EAC85A" format="dita" scope="local">Analytics for Target Implementation</a>. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../a4t/c_a4t_troubleshooting.xml#concept_C380B9DF98AC4299A7A6A437230C4589" format="dita" scope="local">Troubleshooting Analytics and Target Integration (A4T)</a> </p> </td> 
   <td colname="col3"> <p>Added the following item:</p> <p>"I'm not seeing as much data in reports as expected."</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="2">March 9, 2017</td> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_B5077F5503AA4C98901AA99EDCE6CDE6" format="dita" scope="local">Reports</a> </p> </td> 
   <td colname="col3"> <p>Improved all reporting topics in this section, including text additions/corrections/edits and illustrations.</p> <p>Improved search metadata to improve search results for these topics.</p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Added information about why the Experience column was removed from the downloaded Order Details report.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"><a href="../ov2/c_target-atjs-implementation.xml#concept_CAE591DA8C404C22917584ECD4F7494F" format="dita" scope="local">Debugging at.js</a> </td> 
   <td colname="col3"> <p>Removed information about the at.js-readiness bookmarklet that is no longer available.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">March 7, 2017</td> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_D9F21B416F1F49159F03036BA2DD54FD" format="dita" scope="local">Visitor Profile Lifetime</a> </p> </td> 
   <td colname="col3"> <p>Edited entire topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_0D0002A1EBDF420E9C50E2A46F36629B" format="dita" scope="local">Confidence Level and Confidence Interval</a> </p> <p><a href="c_reports.xml#concept_3F276FF2BBB2499388F97451D6DE2E75" format="dita" scope="local">Downloading Data in a CSV File</a> </p> </td> 
   <td colname="col3">Fixed link to the <a href="https://marketing.adobe.com/resources/help/en_US/target/target/complete_confidence_calculator.xlsx" format="xlsx" scope="external">Target's Complete Confidence Calculator</a>. </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="3">March 6, 2017</td> 
   <td colname="col2"> <p><a href="vec-best-pracitces-and-troubleshooting.xml#reference_77743144F10143A3A89D56E116D296E4" format="dita" scope="local">Troubleshooting the Visual Experience Composer</a> </p> </td> 
   <td colname="col3"> <p>Added information about users receiving the following error message: "Uncaught ReferenceError: _AT is not defined."</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Made the following changes:</p> <p> 
     <ul id="ul_48858401BFE0458F90CC337B4E5865D5"> 
      <li id="li_61A86AD282354273B72E5B6BE40044F5"> <p>Moved the "Global exclusion rules" row from the Known Issues table to the Resolved Issues table.</p> </li> 
      <li id="li_325001363D1B42CA807899C9F6857042"> <p>Removed information about targeting specific iPhone models. Information about this issue is now included in <a href="c_target_rules.xml#concept_2A794199DC1A4D349FFFBC7DCF1FEB89" format="dita" scope="local">Mobile</a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_2A794199DC1A4D349FFFBC7DCF1FEB89" format="dita" scope="local">Mobile</a> </p> </td> 
   <td colname="col3"> <p>Added information about limitations of DeviceAtlas when identifying specific iPhone models.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_0D0002A1EBDF420E9C50E2A46F36629B" format="dita" scope="local">Confidence Level and Confidence Interval</a> </p> </td> 
   <td colname="col3"> <p>Added the following new section:</p> <p> 
     <ul id="ul_2A1F674A94684A41A6CD23D2ACF0CAA8"> 
      <li id="li_E38A56635EC945EA92DC30065E875075"> <p>Confidence Calculation and How to Perform It Offline</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="2">March 3, 2017</td> 
   <td colname="col2"> <p><a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Target Release Notes</a> </p> <p><a href="../ov2/c_target-atjs-implementation.xml#concept_D6EFE8D84A06476DB5ABD494D7E8C769" format="dita" scope="local">at.js Frequently Asked Questions</a> </p> <p><a href="../ov2/c_target-atjs-implementation.xml#concept_C100BC4F073C4B57A608B309D0157B39" format="dita" scope="local">at.js Integrations</a> </p> </td> 
   <td colname="col3"> <p>Added the following information:</p> <p> 
     <ul id="ul_4D9E19A08147498087359DF3A89B3E86"> 
      <li id="li_5EDA6535897B424E9EE215D7B1957853"> <p> <span class="keyword">Adobe Experience Manager</span> 6.2 with FP-11577 (or later) now supports <span class="filepath">at.js</span> implementations with its <span class="wintitle">Adobe Target Cloud Services</span> integration. For more information, see <a href="https://docs.adobe.com/docs/en/aem/6-2/release-notes/feature-packs.html" format="html" scope="external">Feature Packs</a> and <a href="https://docs.adobe.com/docs/en/aem/6-2/administer/integration/marketing-cloud/target.html" format="html" scope="external">Integrating with Adobe Target</a> in the <i>Adobe Experience Manager 6.2</i> documentation. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#reference_C81525D1598A4A1199740DCAB81A7FDF" format="dita" scope="local">adobe.target.getOffer(options)</a> </p> </td> 
   <td colname="col3"> <p>Updated example code to include both <span class="codeph">getOffer()</span> and <span class="codeph">applyOffer()</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#reference_F5D9EF735F1044C38E208F3A178903B2" format="dita" scope="local">Useful Variables, Profiles, Parameters, and Methods</a> </p> </td> 
   <td colname="col3"> <p>Added additional information to the <span class="codeph">user.header('x-cluster-client-ip')</span> row. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="2">February 28, 2017</td> 
   <td colname="col2"> <p><a href="t_test_ab.xml#concept_578A7947C9554868B30F12DFF9E3F8E3" format="dita" scope="local">Nine Common A/B Testing Pitfalls and How to Avoid Them</a> </p> </td> 
   <td colname="col3"> <p>New topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added the following known issue and workaround:</p> <p> 
     <ul id="ul_581758E4D33C434FB1E6CB25E53B0388"> 
      <li id="li_C7B8D60D983A4F6C86A4654D911007A8"> <p>When users attempt to download <span class="codeph">at.js</span> from the <a href="../ov2/c_target-atjs-implementation.xml#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Implementation details</a> page after updating <span class="codeph">at.js</span> settings, <span class="codeph">mbox.js</span> is downloaded instead of <span class="codeph">at.js</span>. </p> </li> 
      <li id="li_04A3D8594754464BA5FA6E67FEF95F0A"> <p>Redirect activities in <span class="codeph">at.js</span> implementations cause the preview URL to enter into a loop (the offer is delivered repeatedly). </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="t_redirect_offer.xml#task_9578678D42784F5EB9638F8AC8C911FA" format="dita" scope="local">Redirect to a URL</a> </p> </td> 
   <td colname="col3"> <p>Updated text to indicate that redirect offers when using Analytics for Target (A4T) require <span class="codeph">at.js</span> version 0.9.5 or later. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">February 25, 2017</td> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>The Analytics for Target (A4T) reporting issue was resolved and moved from the <span class="wintitle">Known Issues</span> table to the <span class="wintitle">Resolved Issues</span> table. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="2">February 24, 2017</td> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_01A30B4762D64CD5946B3AA38DC8A201" format="dita" scope="local">Profile Attributes</a> </p> <p><a href="c_troubleshooting_targets_and_audiences.xml#concept_C4EE4B8F4840430CBD798D579A8F208D" format="dita" scope="local">Targets and Audiences Frequently Asked Questions</a> </p> </td> 
   <td colname="col3"> <p>Added the following text:</p> <p> 
     <ul id="ul_CD01259DB84F436DA8F2F58CBBD9F1DB"> 
      <li id="li_E4B7DCE631934167A0C059C6E7C7707F"> <p><span class="keyword">Target</span> has a limit of 50 unique profile attributes per mbox call. If you need to pass more than 50 profile attributes to <span class="keyword">Target</span>, you can pass them using the <span class="wintitle">Profile Update</span> API method. For more information, see <a href="https://www.adobe.io/apis/marketingcloud/target/docs/reference/profiles/profile-update.html" format="html" scope="external">Profile Update</a> in the Adobe Target API documentation. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#reference_7E0F19368F9C4BC38F1E5DC5E717E487" format="dita" scope="local">adobe.target.trackEvent(options)</a> </p> </td> 
   <td colname="col3"> <p>Added the following information:</p> <p> 
     <ul id="ul_A8C247073FCB40FAA0D4FB9EEBB0E321"> 
      <li id="li_FB69A5BD14E44C4CA782DCDCCD5924E0"> <p>These event-tracking mbox calls can then be used to define metrics in activities. For more information, see <a href="../target/r_success_metrics.xml#reference_D011575C85DA48E989A244593D9B9924" format="dita" scope="local">Success Metrics</a> and <a href="../ov2/c_target-atjs-implementation.xml#task_E85D2F64FEB84201A594F2288FABF053" format="dita" scope="local">Create an Order Confirmation mbox - at.js</a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_success_metrics.xml#task_AB0B7EBF96AE4BD1BAB6F7550BBF1504" format="dita" scope="local">Click Tracking</a> </p> </td> 
   <td colname="col3"> <p>Clarified the following text:</p> <p> 
     <ul id="ul_6D117715DF024A7FAC66A825D97B6657"> 
      <li id="li_AE8911356F524FEAA59DCF8BAA0CE5A9"> <p>The destination page must have a Target implementation on it (<span class="filepath">at.js</span>or <span class="filepath">mbox.js</span>). </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">February 22, 2017</td> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added the following known issues and workarounds:</p> <p> 
     <ul id="ul_06A6D4F84F3B46BBAC3C959091B879D2"> 
      <li id="li_6D0BF8EF939B4DCA849D080D9699CEEC"> <p>Global exclusion rules take 10-20 minutes to propagate to the edge for Premium Recommendations.</p> </li> 
      <li id="li_C4E8C7DD4E3E4D9FA8585C39DDD85440"> <p>A4T reports are not updated when the reporting metric is switched.</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="4">February 21, 2017</td> 
   <td colname="col2"> <p><a href="c_target_rules.xml#reference_F5D9EF735F1044C38E208F3A178903B2" format="dita" scope="local">Useful Variables, Profiles, Parameters, and Methods</a> </p> </td> 
   <td colname="col3"> <p> Changed the notes for the <span class="codeph">user.activeActivities</span> and <span class="codeph">user.activeCampaigns</span> profiles. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../recs/c_ip-addresses-marketing-cloud.xml#concept_216F959FF18143D6A3BA0BE937918580" format="dita" scope="local">IP Addresses in the Marketing Cloud</a> </p> </td> 
   <td colname="col3"> <p>New Topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#concept_2FA0456607D04F82B0539C5BF5309812" format="dita" scope="local">Configure at.js</a> </p> <p><a href="../ov2/c_target-atjs-implementation.xml#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">at.js Version Details</a> </p> </td> 
   <td colname="col3"> <p>Added information indicating that the <span class="wintitle">Legacy Browser Support</span> option was removed from <span class="codeph">at.js</span> version 0.9.4. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="r_release_notes.xml#concept_625C3A16B7F24D4B82EFF130F0945541" format="dita" scope="local">Known Issues and Resolved Issues</a> </p> </td> 
   <td colname="col3"> <p>Added the following issue to the <span class="wintitle">Known Issues</span> table: </p> <p> 
     <ul id="ul_152A0E95A99A416199C75EF14D06F5D0"> 
      <li id="li_E73EDF6500404C92A998177DACBD6746"> <p>If you use the Form-Based Experience Composer with an mbox other than the auto-created global mbox (<span class="codeph">target-global-mbox</span>), and then choose an engagement metric as a success metric, the metric increments only on pages that have the mbox used in the activity. As an example, if your mbox is <span class="codeph">homepage_mbox</span>, the <span class="wintitle">Pages Per Visit</span> metric is the number of hits to the <span class="codeph">homepage_mbox</span> during that visit. </p> <p>If this is not what you want, you can add another location to the activity and assign the global mbox to that location and give it default content. This workaround connects the global mbox to the activity and allows Target to count the metric for reporting.</p> </li> 
     </ul> </p> <p>Moved the following issues from the <span class="wintitle">Known Issues</span> table to the <span class="wintitle">Resolved Issues</span> table: </p> <p> 
     <ul id="ul_C306B3731AD9438EA56228614926BA99"> 
      <li id="li_A6F744B89D884C9695AECBAD3A8F0AFD"> <p>Downloaded reports do not honor the <span class="wintitle">Exclude Extreme Orders</span> setting. (TGT-21871) </p> </li> 
      <li id="li_10BCBFBA3D5C42E390720162C963F806"> <p>When you download the <span class="filepath">at.js</span> file, the custom JavaScript code specified in the <a href="../ov2/c_target-atjs-implementation.xml#concept_2FA0456607D04F82B0539C5BF5309812" format="dita" scope="local">Library Header and Library Footer sections</a> is not included. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Release 17.2.1 <a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Release Notes</a> </p> </td> 
   <td colname="col3"> <p>This release includes enhancements and fixes. You can read about them and link to the documentation from the Release Notes. This release also includes many documentation updates throughout the help.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
## Adobe Target Standard/Premium 17.1.1 {#section_21CD599F547C4658AB25EE7B96919967}



<table id="table_4A22C9824822433FA6F17B8E803E1A51"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry">Date</th> 
   <th colname="col2" class="entry">Topic</th> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1" morerows="1">February 7, 2017</td> 
   <td colname="col2"> <p><a href="../a4t/a4t.xml#concept_7540C8C04259434AB6EE33B09F47A1DE" format="dita" scope="local">Adobe Analytics as the Reporting Source for Adobe Target (A4T)</a> </p> </td> 
   <td colname="col3"> <p>Added illustrations of A4T reports.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"><a href="r_success_metrics.xml#task_AB0B7EBF96AE4BD1BAB6F7550BBF1504" format="dita" scope="local">Click Tracking</a> </td> 
   <td colname="col3"> <p>Added following text:</p> <p>Click events are sent to <span class="keyword">Target</span> on the destination page of the click. This means that the destination page must have <span class="keyword">Target</span> installed. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">February 1, 2017</td> 
   <td colname="col2"> <p><a href="automated_traffic_allocation.xml#concept_5741A89ED7224E1285A3BC34B2CCD0F9" format="dita" scope="local">Determine a Winner</a> </p> </td> 
   <td colname="col3"> <p>Minor text edits.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1">January 31, 2017</td> 
   <td colname="col2"> <p><a href="c_managing_audience_filters.xml#concept_DF9534D4168D46D4B109DD0D2FB57781" format="dita" scope="local">Audience Filters for Reporting</a> </p> </td> 
   <td colname="col3"> <p>New topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p><a href="../ov/t_mbox_download.xml#reference_A9C8DAC6DF7743EDBCF1D71F8F20843C" format="dita" scope="local">Configure mbox.js</a> </p> </td> 
   <td colname="col3"> <p>Removed the following settings that are no longer configurable:</p> <p> 
     <ul id="ul_E74BD420DBE2406CAFA3103073A60957"> 
      <li id="li_FA1E7C90ABCC45A9A4658F2B997161C2"> <p>Server Domain</p> </li> 
      <li id="li_07B38B751B0A463CB8EED7C4610FC405"> <p>Client Session Id Support</p> </li> 
      <li id="li_F671025C39E84A5A9DB73818CB9C922F"> <p>Client PC Id Support</p> </li> 
      <li id="li_D56126F6B5844881B51295A3D83B73FF"> <p>Pass Page/Referring URL</p> </li> 
      <li id="li_09F44EA2264549E6A4029882B2D1CAF1"> <p>Traffic Level</p> </li> 
      <li id="li_069E7C75D63748B9BE33D5D6374B0B4E"> <p>Traffic Duration</p> </li> 
      <li id="li_8EB74825FB7E47B5A9B3EB366D31846D"> <p>Get mbox.js as self-extracting JavaScript</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1">January 30, 2017</td> 
   <td colname="col2"> <p><a href="../recs/c_products.xml#concept_E5CF39BCAC8140309A73828706288322" format="dita" scope="local">Custom Entity Attributes</a> </p> </td> 
   <td colname="col3"> <p>Added the following paragraph to the "Implementing Multi-Value Attributes" section:</p> <p>Double quotes must be escaped. For example, <span class="codeph">"[""test"", ""value""]"</span> is a valid JSON array that can be used in CSV. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov/c_target-transition-classic-to-standard.xml#concept_D8DB7801889A464D9197A739F7B185A7" format="dita" scope="local">Advanced Feature Considerations</a> </p> </td> 
   <td colname="col3"> <p>Added information about the <span class="wintitle">Monitoring Campaigns</span> feature in <span class="keyword">Target Classic</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="2">January 27, 2017</td> 
   <td colname="col2"> <p><a href="../recs/c_algorithms.xml#task_8A9CB465F28D44899F69F38AD27352FE" format="dita" scope="local">Creating Criteria Sequences</a> </p> </td> 
   <td colname="col3"> <p>Added the following note:</p> <p> <p>Note: Criteria sequences cannot be used with <span class="wintitle">Recommendations</span> activities created before the October 2016 Release of <span class="keyword">Target Premium</span>. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="automated_traffic_allocation.xml#concept_A1407678796B4C569E94CBA8A9F7F5D4" format="dita" scope="local">Auto-Allocate</a> </p> </td> 
   <td colname="col3"> <p>Updated text throughout topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="vec-best-pracitces-and-troubleshooting.xml#concept_E284B3F704C04406B174D9050A2528A6" format="dita" scope="local">Visual Experience Composer Best Practices and Limitations</a> </p> </td> 
   <td colname="col3"> <p>Added list of IP addresses that can be whitelisted if the Enhanced Visual Experience Composer won't load on secure pages on your site.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="14">January 19, 2017</td> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#concept_2FA0456607D04F82B0539C5BF5309812" format="dita" scope="local">Configure at.js</a> </p> </td> 
   <td colname="col3"> <p>Added information about using special characters in mbox names using <span class="codeph">at.js</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-atjs-implementation.xml#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">at.js Version Details</a> </p> </td> 
   <td colname="col3"> <p>Added information about <span class="codeph">at.js</span> version 0.9.4. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov2/c_target-ats-functions.xml#concept_8DACBC47ABDE4279BB102B42609FE506" format="dita" scope="local">targetGlobalSettings()</a> </p> </td> 
   <td colname="col3"> <p>Added the following settings to the table:</p> <p> 
     <ul id="ul_E013B26F08A34B76855B3032A01DCE58"> 
      <li id="li_C46D3128F8F84DF8946985F7A24FF61F"> <p><span class="codeph">secureOnly</span> </p> </li> 
      <li id="li_DBB54142736E4828A0440F22337B0B96"> <p><span class="codeph">overrideMboxEdgeServer</span> </p> </li> 
      <li id="li_1718DF4C5C2648CCA529D7BB7C4F0045"> <p><span class="codeph">overrideMboxEdgeServer</span> </p> </li> 
      <li id="li_9EAC1970A8AC4C849E36C08CC83700A1"> <p><span class="codeph">optoutEnabled</span> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov/t_mbox_download.xml#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">mbox.js Version Details</a> </p> </td> 
   <td colname="col3"> <p>Added information about <span class="codeph">mbox.js</span> version 62. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../ov/t_mbox_download.xml#reference_A9C8DAC6DF7743EDBCF1D71F8F20843C" format="dita" scope="local">Configure mbox.js</a> </p> </td> 
   <td colname="col3"> <p>Added information about the <span class="codeph">secureOnly</span> setting. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_4BB6A7FDAB6F4806A632F9CD989B8BFA" format="dita" scope="local">Report Settings</a> </p> </td> 
   <td colname="col3"> <p>Added information about new user interface design and new features made available in this release.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_manage_content.xml#concept_17874A6FCBB743AA84C5988E8571CCF3" format="dita" scope="local">Offers</a> </p> </td> 
   <td colname="col3"> <p>Made the following changes:</p> <p> 
     <ul id="ul_55CDA94DC42D4F2DA84ABAEFBDC547B5"> 
      <li id="li_E47598F33F304CD5A61388587907E156"> <p>Changed name of topic from "Content" to "Offers" to reflect changes in the <span class="keyword">Target</span> interface. </p> </li> 
      <li id="li_BE762079C6E643D7867D76481841488C"> <p>Added that offers created via <span class="keyword">Target Classic</span>, <span class="keyword">Adobe Experience Manager</span> (AEM), and APIs are now visible in the <span class="keyword">Target Standard/Premium</span> user interface. </p> </li> 
      <li id="li_2D6B13FEE78A431294D29333CF61F16F"> <p>Added information about the new tabs to separate offers: <span class="wintitle">Code Offers</span> and <span class="wintitle">Image Offers</span>. </p> </li> 
      <li id="li_0913987F197E42328A02B8249E489433"> <p>Added information about the initial synchronization of existing offers.</p> </li> 
      <li id="li_079993C6A6044FDD972F80EDFB381241"> <p>Changed the steps to access the two pages (<span class="wintitle">Code Offers</span> and <span class="wintitle">Image Offers</span>) throughout this topic and its sub topics. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_manage_content.xml#task_E9D147919DF74245BBF49FF145F0E7D7" format="dita" scope="local">Create Offer Folder</a> </p> </td> 
   <td colname="col3"> <p>Edited topic to explain how to perform additional actions on folders on the <span class="wintitle">Code Offers</span> page and on the <span class="wintitle">Image Offers</span> page. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_2A794199DC1A4D349FFFBC7DCF1FEB89" format="dita" scope="local">Mobile</a> </p> </td> 
   <td colname="col3"> <p>Added Device Marketing Name as a built-in option from the drop-down list when creating audiences targeting mobile devices.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_target_rules.xml#concept_5B4D99DE685348FB877929EE0F942670" format="dita" scope="local">Geo</a> </p> </td> 
   <td colname="col3"> <p>Added the following section:</p> <p> 
     <ul id="ul_39D880BDF0FE43719E81333F6AEC08BD"> 
      <li id="li_2D021CFA659E4A78A394E8E2A948C209"> <p>Using Geo-Targeting Values as Tokens</p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../mvt/c_multivariate_testing.xml#task_21A700587E88453A9FC2210C0DE53A28" format="dita" scope="local">Preview Experiences for a Multivariate Test</a> </p> <p><a href="../mvt/c_multivariate_testing.xml#concept_DCE6B45C30F7419B8EC17AFDEE8D8AA6" format="dita" scope="local">Create Combinations</a> </p> </td> 
   <td colname="col3"> <p>Added information about needing to use offline analysis if you exclude more than 10 percent of experiences from a Multivariate Test (MVT).</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="../recs/c_design-overview.xml#concept_94F1554C3F2E4CDB9A2C3D78F10EDA59" format="dita" scope="local">Customizing a Design</a> </p> </td> 
   <td colname="col3"> <p>Changed the maximum number of entities that can be referenced in a design, either hardcoded or via loops, from 20 to 99.</p> <p>Added that the template script length can contain up to 65,000 characters.</p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Added the following FAQ:</p> <p> 
     <ul id="ul_2DFAC219637E425984124C7BBE398A1A"> 
      <li id="li_DD23D0A842554710AC81974D46AD3C65">When building audiences, why are pre-built audiences under <span class="wintitle">Target Library</span> found under other categories? </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><a href="c_reports.xml#concept_EC19BC897D66411BABAF2FA27BCE89AA" format="dita" scope="local">Counting Methodology</a> </p> </td> 
   <td colname="col3"> <p>New topic.</p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>Release 17.1.1 <a href="r_release_notes.xml#reference_8FE40B43A5A34DDF8F26A53D55EE036A" format="dita" scope="local">Release Notes</a> </p> </td> 
