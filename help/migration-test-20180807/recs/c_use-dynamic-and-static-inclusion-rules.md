...
While [creating a promotion](t_adding_promotions.md#task_CC5BD28C364742218C1ACAF0D45E0E14), select ** `Promote by Attribute` **, then click ** `Add Filtering Rule` **. 
...
<table id="table_605D70D1824340279387637819AD1A05"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>equals</p> <p>does not equal</p> <p>is between</p> <p>contains</p> <p>does not contain</p> <p>starts with</p> <p>ends with</p> <p>is greater than or equal to</p> <p>is less than or equal to</p> </td> 
  </tr> 
  <tr> 
...
* Use the `Use a Static Value` option to show media for a specific team (49ers, for example), as in the following illustration: 
