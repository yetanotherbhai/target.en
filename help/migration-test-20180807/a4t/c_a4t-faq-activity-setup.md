...
topic: Standard
uuid: e068c907-a389-4ce0-a60d-b4b7dc8d7ee5
index: y
internal: n
snippet: y
translate: y
...
1. In Adobe Target, click ** `Setup` **.
1. In the ** `Marketing cloud solution used for reporting` ** drop-down list, click ** `Select per Activity` **.
...
To always use Analytics as the reporting source, select ** `Adobe Analytics` ** from the drop-down list in Setup. 
