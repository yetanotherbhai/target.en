...
topic: Standard
uuid: a222cccb-0d66-402b-906a-d811b1911eda
index: y
internal: n
snippet: y
translate: y
...
The ` Target` JavaScript library you are using ( ` mbox.js` or ` at.js`) determines whether or not you need to download a new file: 
...
Or
To copy an existing profile script, from the ` Profile Scripts` list, hover over the desired script, then click the ** ` Copy` ** icon (  ![](../target/graphics/icon_copy.png) ). You can then edit the audience to create a similar audience. 
