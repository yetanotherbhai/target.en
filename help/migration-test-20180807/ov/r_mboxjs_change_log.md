...
uuid: 7a57ed4f-a80e-46db-bea9-fcd758ed0fb2
index: y
internal: n
snippet: y
translate: y
...
* V60 asynchronous calls When using v60 with the visitor id service, all mbox calls are made asynchronously. This is a change from how mboxes have always worked, so be careful if upgrading to this version. Review the [ Asynchronous Considerations ](c_target-atjs-limitations.md#section_B586360A3DD34E2995AE25A18E3FB953) section of the ` at.js` documentation ( ` at.js` also uses asynchronous calls) to understand some of the risks. 
