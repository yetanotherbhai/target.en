...
topic: Standard
uuid: 2391c171-fa75-4583-af65-3563eac5a8de
index: y
internal: n
snippet: y
translate: y
...
* [ Adobe Experience Cloud Debugger ](c_content_trouble.md#section_A2798ED3A431409690A4BE08A1BFCF17) 
...
* [ Redirect and remote offers fail to deliver due to an... ](c_content_trouble.md#section_7D09043B687F43B39DAEDF17D00375AC) 
...
1. Click ** [!UICONTROL  Generate Authentication Token] **. 
   ...
   ![](/migration-test-20180813/assets/gen-auth-token.png) 
...
If your site has a sub domain, such as [!DNL  us.domain.com], but you need the Target cookie set on [!DNL  domain.com] (instead of [!DNL  us.domain.com]), you must override the ` cookieDomain` setting. For more information, see [ targetGlobalSettings() ](cmp_at.js_Functions.md#concept_8DACBC47ABDE4279BB102B42609FE506) 
