...
uuid: 17926b30-30dd-4d9f-998b-c18871c645a2
...
1. (Optional) Click the [!UICONTROL  Download] icon (  ![](/migration-test-20180813/assets/icon_download.png) ) to download the summary view (for example, comparing Control and Targeted traffic) as broken down by all available success metrics. 
...
>[!NOTE]
>
>The [!UICONTROL  Settings] icon (  ![](/migration-test-20180813/assets/icon_gear.png) ) is not available for [!UICONTROL  Automated Personalization] reports. 
...
![](/migration-test-20180813/assets/box_plot_ap.jpg) 
...
![](/migration-test-20180813/assets/ap_OfferLevelRpt.png) 
