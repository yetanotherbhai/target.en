...
topic: Premium
uuid: 4c3da854-6038-405c-81c4-09dcd5f035e4
index: y
internal: n
snippet: y
translate: y
...
>1. Click the gear icon (  ![](/migration-test-20180813/assets/icon_gear.png)) to display the [!UICONTROL  Report Settings] options.

>       ![Step Result](/migration-test-20180813/assets/exclude extreme values.png)1. Toggle the ** [!UICONTROL  Exclude Extreme Values] ** option on or off, as desired.
