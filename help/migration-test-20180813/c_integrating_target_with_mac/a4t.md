...
topic: Standard
uuid: 0b3c2f2d-a819-42ad-9e21-e78408a5a54a
index: y
internal: n
snippet: y
translate: y
...
* [ A4T Overview ](a4t.md#section_92B66069210C40DBA937790E8CC596CF)
* [ Supported Activity Types ](a4t.md#section_F487896214BF4803AF78C552EF1669AA)
* [ Examples of A4T Reports ](a4t.md#section_F0A43A1CB2F04E8282B909E4D7034361)
...
You can toggle between the [!UICONTROL  Table View] (  ![](/migration-test-20180813/assets/icon table view report.png) ) and [!UICONTROL  Graph View] (  ![](/migration-test-20180813/assets/icon graph view report.png) ) of the report by clicking the appropriate icon at the top right side of the report. 
...
![](/migration-test-20180813/assets/a4t report graph1.png) 
...
![](/migration-test-20180813/assets/a4t report graph2.png) 

The following illustration shows the [!UICONTROL  Table View] of an A4T report: 

![](/migration-test-20180813/assets/a4t report table.png) 
