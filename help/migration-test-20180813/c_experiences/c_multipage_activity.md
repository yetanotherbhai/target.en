...
topic: Advanced
uuid: d3bd7335-df1c-420c-9f60-30f27db74e6e
index: y
internal: n
snippet: y
translate: y
...
1. Click ** [!UICONTROL  Add Additional Pages] **. A navigation bar appears on the left of the screen. 
   ...
   ![](/migration-test-20180813/assets/multipage_nav.png) 
...
1. Use that navigational bar to specify your pages and to set the default page. Click ** [!UICONTROL  Add Page] ** to add an additional page. 
   ...
   Click the  ![](/migration-test-20180813/assets/action menu.png) to display an action menu: 

   ![](/migration-test-20180813/assets/multipage_menu.png) 
