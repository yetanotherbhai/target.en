...
topic: Standard
uuid: ad2fc9b1-8341-4c11-a745-1a4de12ff80a
index: y
internal: n
snippet: y
translate: y
...
>[!NOTE]
>
>This feature requires that you are an Adobe Experience Manager (AEM) customer. See[ Requirements ](aem-experience-fragments.md#section_AE6F0971E1574B3AA324003599B96E5A), below, for more information. 
...
* [ Using Experiment Fragments in Target Activities ](aem-experience-fragments.md#section_17CE4BE6B2B74CCEBAE0C68DEB84ABB9) 

* [ Experience Fragment Training Video ](aem-experience-fragments.md#section_C0EDC54063464F41A182492D2045BC64) 
...
<table id="table_A7836BBD5DEB4A088E30B1B1445F2D15"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <img href="/migration-test-20180813/assets/step1_icon.png" id="image_7928C84A792946B384383AD7E03EB911" /> Integrate AEM with Target </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <img href="/migration-test-20180813/assets/step2_icon.png" id="image_CF1B3C977051478B8B0ABE3D41429122" /> Create the experience fragment </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <img href="/migration-test-20180813/assets/step3_icon.png" id="image_6FBEE3C0B9494944B4AC4960803D6A20" /> Configure AEM to share the experience fragment with Target </p> </td> 
   <td colname="col2"> <p> 
  ...
  <tr> 
   <td colname="col1" morerows="1"> <p> <img href="/migration-test-20180813/assets/step4_icon.png" id="image_ACC43C96B1894B04BFD2A3AAF5C1A45A" /> Publish the experience fragment and export it into Target </p> </td> 
   <td colname="col2"> <p> <b>AEM 6.3:</b> </p> <p> 
     <ol id="ol_7700A6562F514538BBDB24EA542B3D2A"> 
      ...
      <li id="li_F2F2BF28564C422D824DF1E972E7C696"> <p>From within AEM, select the desired experience fragment, click <span class="uicontrol"> Export to Adobe Target </span>, then click <span class="uicontrol"> OK </span>. </p> <p style="text-align: center;"> <img href="/migration-test-20180813/assets/experience fragment export to target.png" id="image_5A03C93F0A7D40B786D77DE24E24C16B" /> </p> </li> 
     </ol> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p><b>AEM 6.4:</b> </p> <p> 
     <ol id="ol_027758DB9ED443EABB85F60519019922"> 
      <li id="li_1E664C716E394516AEC38CC9002426CA"> <p>From within AEM, select the desired experience fragment, click <span class="uicontrol"> Export to Adobe Target </span>. </p> <p style="text-align: center;"> <img href="/migration-test-20180813/assets/experience fragment export to target.png" id="image_FD1DE3B3569E4090B3B37FE3EE190DEE" /> </p> </li> 
...
You can hover over an experience fragment in the list, then click the View icon (  ![](/migration-test-20180813/assets/icon_info.png) ) to see additional information about the experience fragment, including its public offer delivery URL, its AEM path, and a deep link to open the experience fragment inside of AEM. 
...
1. In Target, while creating or editing an experience in the [ Visual Experience Composer ](c_experiences.md#concept_A2E10F6AFB3D4AEAB6951EE14688848D), click the location on the page where you want to insert AEM content, then select ** [!UICONTROL  Swap with Experience Fragment] ** to display the [!UICONTROL  Choose an Experience Fragment] list. 
   ...
   ![](/migration-test-20180813/assets/experience fragment list.png) 
...
1. Finish configuring the activity. 
    ...
    * **A/B Test: ** [ Create an A/B Test ](t_test_create_ab.md#task_68C8079BF9FF4625A3BD6680D554BB72) 
    ...
    * **Automated Personalization (AP): ** [ Creating an Automated Personalization Activity ](t_create_ap_activity.md#task_8AAF837796D74CF893CA2F88BA1491C9) 

    * **Experience Targeting (XT): ** [ Create an Experience Targeting Activity ](t_xt_create.md#task_D6B3429AC31549E1A70EDF04B3DDC765) 

    * **Multivariate Test (MVT): ** [ Create a Multivariate Test ](t_create_multivariate_test.md#task_BF870FA60A8245AB8F0B775BE32EA710) 
