...
uuid: 5a12e850-eee8-4972-8825-82e3571a53a0
index: y
internal: n
snippet: y
translate: y
...
1. While creating an activity, in the ** [!UICONTROL  Audience] ** box, click the ** [!UICONTROL  Edit] ** icon (  ![](/migration-test-20180813/assets/icon_more_options.png) ), then click ** [!UICONTROL  Replace Audience] **. 

   ![](/migration-test-20180813/assets/replace audiience.png) 

1. On the Choose Audience page, click ** [!UICONTROL  Activity Only Audience] **. 

   ![](/migration-test-20180813/assets/activity-only-aud.png) 
