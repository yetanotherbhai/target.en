...
uuid: 83bebcdb-92b2-4077-83ce-2f78911b19a2
index: y
internal: n
snippet: y
translate: y
...
* [ Create Profile Scripts ](c_profile_parameters.md#section_CB02F8B97CAF407DA84F7591A7504810)
* [ Viewing Profile Script Information Cards ](c_profile_parameters.md#section_18EA3B919A8E49BBB09AA9215E1E3F17)
* [ Target Disables Profile Scripts in Certain Situations ](c_profile_parameters.md#section_C0FCB702E60D4576AD1174D39FBBE1A7)
* [ Best Practices ](c_profile_parameters.md#section_64AFE5D2B0C8408A912FC2A832B3AAE0)
* [ Profile Scripts to Test Mutually Exclusive Activities ](c_profile_parameters.md#section_FEFE50ACA6694DE7BF1893F2EFA96C01)
* [ Debug Profile Scripts ](c_profile_parameters.md#section_E9F933DE47EC4B4E9AF2463B181CE2DA)
...
To copy an existing profile script, from the [!UICONTROL  Profile Scripts] list, hover over the desired script, then click the ** [!UICONTROL  Copy] ** icon (  ![](/migration-test-20180813/assets/icon_copy.png) ). You can then edit the audience to create a similar audience. 

![](/migration-test-20180813/assets/profile-script.png) 
...
![](/migration-test-20180813/assets/profile script info card.png) 

The [!UICONTROL  Script Usage] tab lists the activities (and their workspaces) that reference the selected profile script. 

![](/migration-test-20180813/assets/profile script info card usage tab.png) 
...
![](/migration-test-20180813/assets/profile script invalid.png) 

On hover, details on the error display, as illustrated below: 

![](/migration-test-20180813/assets/profile script hover.png) 
...
* Not following items highlighted in the [ best practices ](c_profile_parameters.md#section_64AFE5D2B0C8408A912FC2A832B3AAE0) section below. 
...
* **Add Profile Scripts as Response Tokens to Debug Profile Scripts:** 
  ...
  ![](/migration-test-20180813/assets/debug profile script 1.png) 
...
* **Use the mboxTrace Debugging Tool to Debug Profile Scripts.** 
  ...
  ![](/migration-test-20180813/assets/debug profile script 2.png) 
