...
topic: Standard
uuid: 7a99940c-10bd-4f6a-8b76-ba4d28f4bf65
index: y
internal: n
snippet: y
translate: y
...
![](/migration-test-20180813/assets/crs.png) 
...
![](/migration-test-20180813/assets/crm workflow.png) 
...
1. Create a data file. 
   ...
   ![](/migration-test-20180813/assets/CRS_sample.png) 

   ![](/migration-test-20180813/assets/CRS_CSV_sample.png) 
...
1. Validate the schema. 
   ...
   ![](/migration-test-20180813/assets/SchemaValidate.png) 

   ![](/migration-test-20180813/assets/upload1.png) 
...
1. Configure subscriptions and activate the attribute source. 
   ...
   ![](/migration-test-20180813/assets/solution.png.jpeg) 

   ![](/migration-test-20180813/assets/activate.PNG) 
...
<table id="table_96AB5A9C2F17437489DF4C42642EB6D3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="keyword"> Target </span>, you can select a customer attribute from the <span class="wintitle"> Visitor Profile </span> section when creating an audience. All customer attributes have the prefix &lt; <span class="varname"> data_source_name </span>&gt; in the list. Combine these attributes as required with other data attributes to build audiences. </p> <p style="text-align: center;"> <img href="/migration-test-20180813/assets/TargetAudience.png" id="image_00473D9BBCE843DAB2C1736FE52CB3DE" /> </p> </td> 
  </tr> 
  <tr> 
