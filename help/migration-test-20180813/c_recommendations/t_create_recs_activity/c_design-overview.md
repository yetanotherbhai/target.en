...
topic: Premium
uuid: ba832591-973a-406f-8a54-a3d889cc0beb
index: y
internal: n
snippet: y
translate: y
...
* [ JSON Example ](c_design-overview.md#section_75BFB2537CFF4FBD9B560F59EB32C8DD)
* [ Additional JSON Object Tips and Tricks ](c_design-overview.md#section_C305673C68944749969DB239E3221DC2)
...
1. Ensure that the "HTML Design" option is turned off: 
   ...
   ![](/migration-test-20180813/assets/html design toggle.png) 
...
<table id="table_74D9504F935C46C7A2E36FA912C96AE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   ![](/migration-test-20180813/assets/json recommendation.png) 
