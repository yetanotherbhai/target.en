...
topic: Premium
uuid: 1c58f7c5-6134-4e10-8d1a-41eaa27637bf
...
* [ Creating Criteria ](t_create_new_algorithm.md#task_8A9CB465F28D44899F69F38AD27352FE) 

* [ Base the Recommendation on a Recommendation Key ](t_create_new_algorithm.md#task_2B0ED54AFBF64C56916B6E1F4DC0DC3B) 

* [ Inclusion Rules ](t_create_new_algorithm.md#task_28DB20F968B1451481D8E51BAF947079) 

* [ Attribute Weighting ](t_create_new_algorithm.md#task_2AEDA0DB15B74770B76F6982B24C2E42) 

* [ Content Settings ](t_create_new_algorithm.md#concept_BC16005C7A1E4F1A87E33D16221F4A96) 
...
>       ![](/migration-test-20180813/assets/CreateNewCriteria_full.png) 
...
>       >[!NOTE]
>       >
>       >If you select ** [!UICONTROL  Items] **/ ** [!UICONTROL  Media with Similar Attributes] **, you will have the option to set [ content similarity rules ](t_create_new_algorithm.md#concept_5402DAFA279C4E46A9A449526889A0CB). 
...
>       For more details, see [ Inclusion Rules ](t_create_new_algorithm.md#task_28DB20F968B1451481D8E51BAF947079). 
...
>       See [ Attribute Weighting ](t_create_new_algorithm.md#task_2AEDA0DB15B74770B76F6982B24C2E42). 
...
>       ![](/migration-test-20180813/assets/Recs_InclusionRules.png) 
...
>       ![](/migration-test-20180813/assets/Recs_AttributeWeighting.png) 
...
If you enable ** [!UICONTROL  Show Backup Recommendations] **, the option to apply your [ inclusion rules ](t_create_new_algorithm.md#task_28DB20F968B1451481D8E51BAF947079) to backup recommendations is enabled by default. 

![](/migration-test-20180813/assets/Recs_ContentControls.png) 
...
![](/migration-test-20180813/assets/ContentSimilarity.png) 
