...
title: Activities
topic: Standard
uuid: 0da441e9-498f-4f79-a586-81178595887b
index: y
internal: n
snippet: y
translate: y
...
<table id="table_B68BB1AD61394C749822FF4938E404E7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Change the activity. Any activity can be edited. </p> <p>For more information about the various ways you can edit activities, see <a href="c_edit-activity.xml#concept_BB064C0D4A194BD1A1AE7CCA1E6BB8F0" format="dita" scope="local"> Edit an Activity </a>. </p> </td> 
  </tr> 
  <tr> 
...
![](/migration-test-20180813/assets/activities_search.png) 
...
![](/migration-test-20180813/assets/activities_filters.png) 
...
For additional limits of the Visual Experience Composer, see [ Visual Experience Composer Limitations ](c_experience_composer_best_practices.md#section_F33C2EA27F2E417AA036BC199DD6C721). 
