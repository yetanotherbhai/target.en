...
topic: Standard
uuid: 1a86dd52-79ab-43e4-92a2-c2fdfb4e5a2c
index: y
internal: n
snippet: y
translate: y
...
![](/migration-test-20180813/assets/auto_traffic_no_winner.png) 

When a clear winner is declared, [!DNL  Target] displays "Winner: Experience X." 

![](/migration-test-20180813/assets/auto_traffic_winner.png) 
...
![](/migration-test-20180813/assets/no_winner.png) 

The following illustration shows an activity that has a winner: 

![](/migration-test-20180813/assets/winner_found.png) 
