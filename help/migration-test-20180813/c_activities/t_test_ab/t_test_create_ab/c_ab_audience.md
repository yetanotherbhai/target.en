...
topic: Standard
uuid: 8ca81a01-5873-4ff0-ab91-a866e0f0ff21
index: y
internal: n
snippet: y
translate: y
...
In the [!UICONTROL  Audience] box, click the Edit icon (  ![](/migration-test-20180813/assets/icon_more_options.png) ), then click ** [!UICONTROL  Replace Audience] **. 
...
![](/migration-test-20180813/assets/audience picker hover.png) 
