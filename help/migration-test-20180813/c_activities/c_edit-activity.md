...
topic: Standard
uuid: 48d4b8fb-8d62-4b30-8fea-3c7105e3e938
index: y
internal: n
snippet: y
translate: y
...
1. From the ** [!UICONTROL  Activities] ** page, hover over the activity you want to edit, then click the ** [!UICONTROL  Edit] ** icon (  ![](/migration-test-20180813/assets/icon_edit.png) ). 

   ![](/migration-test-20180813/assets/hover_edit.png) 
   ...
   ![](/migration-test-20180813/assets/edit split button.png) 

1. Edit the activity, as desired using the split button: 

   ![](/migration-test-20180813/assets/edit split button 2.png) 
...
1. To avoid having to step through the workflow, click the desired activity from the Activities page to open it, then select an option from the ** [!UICONTROL  Edit Activity] ** drop-down list. 
   ...
   ![](/migration-test-20180813/assets/edit activity.png) 
...
1. Select the desired option from the split button: 
   ...
   ![](/migration-test-20180813/assets/save draft.png) 
