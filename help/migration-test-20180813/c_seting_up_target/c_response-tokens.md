...
topic: Standard
uuid: a222beeb-aad2-4501-ba9a-ae0536250c86
index: y
internal: n
snippet: y
translate: y
...
* [ Using Response Tokens ](c_response-tokens.md#section_A9E141DDCBA84308926E68D05FD2AC62)
* [ Response Token FAQs ](c_response-tokens.md#section_3DD5F32C668246289CDF9B4CDE1F536D)
* [ Sending Data to Google Analytics via at.js ](c_response-tokens.md#section_04AA830826D94D4EBEC741B7C4F86156)
* [ Debugging (similar to ttMeta plugin) ](c_response-tokens.md#section_DB3392B6E80749C1BFB520732EDF3BCE)
...
1. Ensure that you are using [!DNL  at.js] version 1.1 or later. 
   ...
   For more information, see [ Download at.js ](c_target-configure-atjs.md#concept_1E1F958F9CCC4E35AD97581EFAF659E2). 

1. In [!DNL  Target], click ** [!UICONTROL  Setup] ** > ** [!UICONTROL  Response Tokens] **. 

   ![](/migration-test-20180813/assets/response tokens.png) 
...
1. (Conditional) If you want to use a profile parameter as a response token, but the parameter has not been passed through an mbox call and, thus, has not loaded into the Target UI, you can use the Create button to add the profile to the UI. 
   ...
   ![](/migration-test-20180813/assets/response token create.png) 

1. Create an activity. 



Use [ at.js custom events ](cmp_at.js_Functions.md#reference_A828E4BA535F4E7692A075F3D70CF6CD) to listen for the mbox response and read the response tokens. 
...
You can add the following snippet to the library footer [ at.js Setup page ](c_target-atjs-advanced-settings.md#concept_2FA0456607D04F82B0539C5BF5309812) if you want to have everything is a single file. 
