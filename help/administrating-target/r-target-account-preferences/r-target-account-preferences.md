...
Select the optional custom mbox name you are using to deliver [!DNL Target] activities. This global mbox must be empty, meaning it has no default content. Save this setting only after the updated [!DNL mbox.js] file is installed on your site.
