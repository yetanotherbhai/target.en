...
seo-description: Details about how at.js 2.0 and at.js 1.x handle cookies
seo-title: at.js cookies
solution: Target
...
Information about at.js 2.0 and at.js 1.*x* cookie behavior.

## at.js 2.0 cookie behavior

For at.js version 2.0, *only first-party cookies are supported*. Just like in at.js 1.*x*, the first-party cookie, “mbox,” is stored in `clientdomain.com`, where `clientdomain` is your domain.
