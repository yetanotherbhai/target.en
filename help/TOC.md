...
+ Activities {#activities}
   ...
   + Experience Targeting {#experience-targeting}
      ...
      + [Bob Experience Targeting overview](c-activities/t-experience-target/t-experience-target.md)
      + Create an Experience Targeting activity {#create-targeting}
         ...
         + [Bob Create an activity](c-activities/t-experience-target/t-xt-create/t-xt-create.md)
         + [Bob Activity URL](c-activities/t-experience-target/t-xt-create/c-xt-activity-url.md)
         + [Bob Create an experience](c-activities/t-experience-target/t-xt-create/t-xt-add-experience.md)
         + [Bob Switching Experiences in Experience Targeting](c-activities/t-experience-target/t-xt-create/c-xt-switching-experiences.md)
         + [Bob Goals and Settings](c-activities/t-experience-target/t-xt-create/r-xt-goals-and-settings.md)
         + [Bob Set Metrics](c-activities/t-experience-target/t-xt-create/t-xt-set-metrics.md)
   + Multivariate Test {#multivariate-test}
      ...
      + [Bob Multivariate Test overview](c-activities/c-multivariate-testing/c-multivariate-testing.md)
      + [Bob Multivariate Test best practices](c-activities/c-multivariate-testing/r-best-practices.md)
      + [Bob Plan a Multivariate Test](c-activities/c-multivariate-testing/c-plan-mvt.md)
      + Create a Multivariate Test {#create-mvt}
         ...
         + [Bob Create a test](c-activities/c-multivariate-testing/t-create-multivariate-test/t-create-multivariate-test.md)
         + [Bob Activity URL](c-activities/c-multivariate-testing/t-create-multivariate-test/c-url.md)
         + [Bob Create combinations](c-activities/c-multivariate-testing/t-create-multivariate-test/c-add-offers.md)
         + [Bob Preview experiences for a Multivariate Test](c-activities/c-multivariate-testing/t-create-multivariate-test/t-preview-experiences.md)
         + [Bob Estimate the traffic required for a successful test](c-activities/c-multivariate-testing/t-create-multivariate-test/t-traffic-estimator.md)
         + [Bob Test summary](c-activities/c-multivariate-testing/t-create-multivariate-test/r-test-summary.md)
         + [Bob Goals and settings](c-activities/c-multivariate-testing/t-create-multivariate-test/r-goals-and-settings.md)
         + [Bob Set metrics](c-activities/c-multivariate-testing/t-create-multivariate-test/t-mvt-set-metrics.md)
         + [Bob Troubleshoot Multivariate Tests](c-activities/c-multivariate-testing/t-create-multivariate-test/r-troubleshooting.md)
   ...
   + [Bob Recommendations activity](c-activities/c-recommendations-activity.md)
   + [Bob Edit an activity or save as draft](c-activities/c-edit-activity.md)
   + [Bob Priority](c-activities/c-priority.md)
   + [Bob Activity settings](c-activities/t-activity-settings.md)
   + Success metrics {#success-metrics}
      ...
      + [Bob Success metrics](c-activities/r-success-metrics/r-success-metrics.md)
      + [Bob Click tracking](c-activities/r-success-metrics/t-click-tracking.md)
      + [Bob Capture Score](c-activities/r-success-metrics/c-capture-score.md)
   + [Activity Change Log](c-activities/change-log.md)
   + [Bob Activity Change Log](c-activities/t-change-log.md)
   + Troubleshoot activities {#troubleshoot-activities}
      ...
      + [Bob Troubleshoot activities overview](c-activities/c-troubleshooting-activities/c-troubleshooting-activities.md)
      + [Bob Troubleshoot content delivery](c-activities/c-troubleshooting-activities/c-content-trouble.md)
   + Activity QA {#activity-qa}
      ...
      + [Bob Activity QA overview](c-activities/c-activity-qa/c-activity-qa.md)
      + [Bob Activity QA bookmarklet](c-activities/c-activity-qa/c-activity-qa-bookmark.md)
      + [Bob Use Activity QA with server-side delivery](c-activities/c-activity-qa/c-use-qa-mode-with-server-side-delivery.md)
   + [Bob Activity notifications](c-activities/c-notifications.md)
