...
+ Implement Target {#implement-target}
   ...
   + Client-side web: implement Target {#client-side}
      ...
      + at.js functions {#functions-overview}
         ...
         + [adobe.target.getOffer(options)](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getOffer(options).md)
         + [adobe.target.getOffers(Options) - at.js 2.0.0](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getOffers(options)-atjs-2.md)
         + [adobe.target.applyOffer(options)](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-applyOffer(options).md)
         + [adobe.target.applyOffers(options) - at.js 2.0.0](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-applyOffers(options)-atjs-2.md)
         ...
         + [adobe.target.trackEvent(options)](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-trackEvent(options).md)
         + [mboxCreate(mbox,params) - at.js 1.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/mboxCreate-atjs-1x.md)
         + [targetGlobalSettings()](/help/c-implementing-target/c-implementing-target-for-client-side-web/targetGlobalSettings.md)
