...
+ Audiences {#audiences}
   ...
   + [Bob Audiences overview](c-target/c-target.md)
   + [Bob How targeting works](c-target/c-target-how-target-works.md)
   + Create audiences {#create-audiences}
      + [Create](c-target/c-audiences/audiences.md)
      + [Build audiences in Target](c-target/c-audiences/create-audience.md)
      + [Bob Create](c-target/c-audiences/c-audiences.md)
      + [Bob Build audiences in Target](c-target/c-audiences/t-create-audience.md)
      + Categories for audiences {#categories-audiences}
         ...
         + [Bob Categories for audiences overview](c-target/c-audiences/c-target-rules/c-target-rules.md)
         + [Bob Browser](c-target/c-audiences/c-target-rules/c-browser.md)
         + [Bob Custom parameters](c-target/c-audiences/c-target-rules/c-custom-parameters.md)
         + [Bob Geo](c-target/c-audiences/c-target-rules/c-geo.md)
         + [Bob Network](c-target/c-audiences/c-target-rules/c-network.md)
         + [Bob Mobile](c-target/c-audiences/c-target-rules/c-mobile.md)
         + [Bob Operating System](c-target/c-audiences/c-target-rules/c-operating-system.md)
         + [Bob Site Pages](c-target/c-audiences/c-target-rules/c-site-pages.md)
         + [Bob Target Library](c-target/c-audiences/c-target-rules/c-target-library.md)
         + [Bob Time Frame](c-target/c-audiences/c-target-rules/c-time-frame.md)
         + [Bob Traffic Sources](c-target/c-audiences/c-target-rules/c-traffic-sources.md)
         + [Bob Visitor Profile](c-target/c-audiences/c-target-rules/c-visitor-profile.md)
      + [Create a profile attribute comparison audience](c-target/c-audiences/creating-a-profile-attribute-comparison-audience.md)
      + [Bob Create a profile attribute comparison audience](c-target/c-audiences/c-creating-a-profile-attribute-comparison-audience.md)
   ...
   + Visitor profiles {#visitor-profiles}
      ...
      + [Bob Visitor profiles overview](c-target/c-visitor-profile/c-visitor-profile.md)
      + [Bob Visitor profile lifetime](c-target/c-visitor-profile/c-visitor-profile-lifetime.md)
      + [Bob Profile attributes](c-target/c-visitor-profile/c-profile-parameters.md)
      + [Bob Category affinity](c-target/c-visitor-profile/c-category-affinity.md)
      + [Bob Customer attributes](c-target/c-visitor-profile/c-working-with-customer-attributes.md)
      + [Bob Real-time profile syncing for mbox3rdPartyID](c-target/c-visitor-profile/c-3rd-party-id.md)
      + [Bob Profile and variable glossary](c-target/c-visitor-profile/r-variables-profiles-parameters-methods.md)
   + Targets and audiences FAQ {#faq-audiences}
      ...
      + [Bob Targets and audiences FAQ](c-target/c-troubleshooting-targets-and-audiences/c-troubleshooting-targets-and-audiences.md)
      + [Bob Share metrics, audiences, and reports - A4T FAQ](c-target/c-troubleshooting-targets-and-audiences/c-a4t-faq-sharing-metrics-audiences-reports.md)
+ Experiences and offers {#experiences}
   + [Experiences and offers overview](c-experiences/experiences.md)
   + [Bob Experiences and offers overview](c-experiences/c-experiences.md)
   + Visual Experience Composer (VEC)
      ...
      + [Bob Visual Experience Composer overview](c-experiences/c-visual-experience-composer/c-visual-experience-composer.md)
      + [Bob Visual Experience Composer Options](c-experiences/c-visual-experience-composer/r-viztarget-options.md)
      + [Bob Include the Same Experience on Similar Pages](c-experiences/c-visual-experience-composer/t-temtest.md)
      + [Bob Multipage Activity](c-experiences/c-visual-experience-composer/c-multipage-activity.md)
      + [Bob Activity Collisions](c-experiences/c-visual-experience-composer/c-activity-collisions.md)
      + Modifications {#modifications}
         ...
         + [Bob Modifications overview](c-experiences/c-visual-experience-composer/c-vec-code-editor/c-vec-code-editor.md)
         + [Bob Experience Templates](c-experiences/c-visual-experience-composer/c-vec-code-editor/c-experience-templates.md)
      ...
      + [Bob Element Selectors Used in the Visual Experience Composer](c-experiences/c-visual-experience-composer/c-vec-selectors.md)
      + [Bob Mobile Viewports for Responsive Experiences](c-experiences/c-visual-experience-composer/c-mobile-viewports.md)
      + [Bob Visual Experience Composer Best Practices and Limitations](c-experiences/c-visual-experience-composer/c-experience-composer-best-practices.md)
      + Troubleshooting the Visual Experience Composer {#troubleshoot-composer}
         ...
         + [Bob Troubleshooting the Visual Experience Composer overview](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/r-troubleshoot-composer.md)
         + [Bob Visual Experience Composer and Enhanced Experience Composer](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/c-issues-related-to-the-visual-experience-composer-vec-and-enhanced-experience-composer-eec.md)
         + [Bob Visual Experience Composer](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/c-troubleshooting-issues-related-to-the-visual-experience-composer-vec.md)
         + [Bob Troubleshooting Issues Related to the Enhanced Experience Composer](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/c-troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md)
         + [Bob Enabling Mixed Content in Your Browser](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/c-mixed-content.md)
         + [Bob Page Modification Scenarios](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/c-vec-scenarios.md)
      ...
      + [Bob Redirect to a URL](c-experiences/c-visual-experience-composer/t-redirect-offer.md)
      + [Bob Creating Carousels that Work in the Visual Experience Composer](c-experiences/c-visual-experience-composer/t-vec-carousels.md)
   ...
   + Offers {#offers}
      ...
      + [Bob Offers overview](c-experiences/c-manage-content/c-manage-content.md)
      + [Bob Create offer folder](c-experiences/c-manage-content/t-create-content-folder.md)
      + [Bob Uploading Content](c-experiences/c-manage-content/t-assets-upload.md)
      + [Bob Create redirect offers](c-experiences/c-manage-content/t-offer-redirect.md)
      + [Bob Create remote offers](c-experiences/c-manage-content/c-about-remote-offers.md)
      + [Bob Create JSON offers](c-experiences/c-manage-content/c-create-json-offer.md)
...
+ Reports {#reports}
   ...
   + Report setttings {#settings}
      ...
      + [Bob Report settings overview](c-reports/c-report-settings/c-report-settings.md)
      + [Bob View multiple metrics in a report](c-reports/c-report-settings/c-view-multiple-metrics.md)
      + [Bob Exclude extreme values](c-reports/c-report-settings/t-excluding-extreme-orders.md)
   ...
   + [Bob Auto-Target Summary report](c-reports/c-auto-target-summary-report.md)
   + [Bob Automated Personalization Summary reports](c-reports/c-reports-ap.md)
   + Personalization Insights report {#insights}
      ...
      + [Bob Personalization Insights reports overview](c-reports/c-personalization-insights-reports/c-personalization-insights-reports.md)
      + [Bob Automated Segments report](c-reports/c-personalization-insights-reports/c-automated-segments-report.md)
      + [Bob Important Attributes report](c-reports/c-personalization-insights-reports/c-important-attributes-report.md)
   ...
   + [Bob Offer reporting groups in Automated Personalization](c-reports/c-offer-reporting-groups-in-automated-personalization.md)
   + [Bob Experience Performance report (MVT)](c-reports/c-experience-performance-report.md)
   + [Bob Location Contribution report (MVT)](c-reports/c-location-contribution-report.md)
   + [Bob Analytics for Target (A4T) reporting](c-reports/c-analytics-for-target-a4t-reporting.md)
   + [Bob Conversion rate](c-reports/c-conversion-rate.md)
   + [Bob Downloading data in a CSV file](c-reports/c-downloading-data-in-csv-file.md)
   + [Bob Reporting FAQ](c-reports/c-reporting-frequently-asked-questions.md)
+ Recommendations {#recommendations}   
   ...
   + [Bob Recommendations overview](c-recommendations/c-recommendations.md)
   + [Bob Plan and implement Recommendations](c-recommendations/c-plan-implement.md)
   + Entities {#entities} 
      ...
      + [Bob Entities overview](c-recommendations/c-products/c-products.md)
      + [Bob Entity attributes](c-recommendations/c-products/r-entity-attributes.md)
      + [Bob Custom entity attributes](c-recommendations/c-products/c-custom-entity-attributes.md)
      + [Bob Feeds](c-recommendations/c-products/c-feeds.md)
      + [Bob Catalog search](c-recommendations/c-products/c-catalog-search.md)
      + [Bob Collections](c-recommendations/c-products/c-collections.md)
      + [Bob Exclusions](c-recommendations/c-products/t-exclusions.md)
   + Criteria {#criteria}
      ...
      + [Bob Criteria overview](c-recommendations/c-algorithms/c-algorithms.md)
      + [Bob Create criteria](c-recommendations/c-algorithms/t-create-new-algorithm.md)
      + [Bob Create criteria sequences](c-recommendations/c-algorithms/t-create-criteria-sequence.md)
      + [Bob Upload custom criteria](c-recommendations/c-algorithms/t-recommendations-csv.md)
      + [Bob Use dynamic and static inclusion rules](c-recommendations/c-algorithms/c-use-dynamic-and-static-inclusion-rules.md)
      + [Bob Use a backup recommendation](c-recommendations/c-algorithms/c-backup-recs.md)
   + Design {#recommendations-design}
      ...
      + [Bob Design overview](c-recommendations/c-design-overview/c-design-overview.md)
      + [Bob Create a design](c-recommendations/c-design-overview/t-create-design.md)
      + [Bob Design FAQ](c-recommendations/c-design-overview/c-template-faq.md)
      + [Bob Customize a design using Velocity](c-recommendations/c-design-overview/c-customizing-a-template.md)
   + Activity {#recommendations-activity}
      ...
      + [Bob Create a Recommendations activity](c-recommendations/t-create-recs-activity/t-create-recs-activity.md)
      + [Bob Select criteria](c-recommendations/t-create-recs-activity/t-algo-select-recs.md)
      + [Bob Add promotions](c-recommendations/t-create-recs-activity/t-adding-promotions.md)
      + [Bob Recommendations Activity settings](c-recommendations/t-create-recs-activity/r-recs-activity-settings.md)
   ...
   + Frequently asked questions {#recommendations-faq}
      ...
      + [Bob Recommendations FAQ](c-recommendations/c-recommendations-faq/c-recommendations-faq.md)
      + [Bob Integrate Recommendations with email](c-recommendations/c-recommendations-faq/r-integrating-recs-email.md)
      + [Bob IP addresses used by Recommendations feed-processing servers](c-recommendations/c-recommendations-faq/c-ip-addresses-marketing-cloud.md)
      + [Bob Recommendations Classic versus Recommendations activities in Target Premium](c-recommendations/c-recommendations-faq/c-recommendations-classic-versus-recommendations-activities-target-premium.md)
...
+ Troubleshoot Target {#troubleshoot}
   ...
   + [Bob Troubleshoot Target](r-troubleshooting-target/r-troubleshooting-target.md)
   + [Bob Limits](r-troubleshooting-target/r-target-limits.md)
